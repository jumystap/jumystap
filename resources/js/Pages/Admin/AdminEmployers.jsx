...
export default function AdminEmployers({ employers }) {
    const { url } = usePage();
    ...
    return (
        <AdminLayout>
            <div className="text-2xl font-bold">Работодатели</div>
            ...
            <Table className="mt-5" columns={columns} dataSource={employers} />
        </AdminLayout>
    );
}
