                    ...
                    <div className='flex-1'>
                        ...
                        <div className='bg-[#FFF9F9] rounded-2xl p-6 md:p-10 flex flex-col md:flex-row items-center justify-between mb-6 relative overflow-hidden border border-gray-100'>
                            ...
                            <div className='mt-6 md:mt-0 relative z-10'>
                                <img src="/images/service-banner-icon.png" alt="Marketplace" className="w-48 md:w-80 object-contain ml-auto" onError={(e) => e.target.style.display='none'} />
                                ...
                                {!document.querySelector('img[src="/images/service-banner-icon.png"]') && (
                                    <div className="w-40 h-48 md:w-56 md:h-72 bg-[#E67E22]/10 rounded-3xl transform rotate-6 flex items-end justify-center p-6 ml-auto">
                                        <div className="w-24 h-40 md:w-32 md:h-56 bg-[#E67E22] rounded-2xl transform rotate-6 opacity-90 shadow-2xl"></div>
                                    </div>
                                )}
                            </div>
                        </div>

                        <div className='flex gap-4 mb-6 w-full md:w-max'>
                            <button
