                ...
                <div className='grid grid-cols-1 md:grid-cols-3 pt-10 gap-5'>
                    <div className="md:p-10">
                        <div className='md:mb-10 mb-2'>
                            ...
                            <div className="flex-wrap">
                                <div className="inline-block mr-1 mt-3 px-4 text-sm text-orange-500 py-2 rounded-full border border-orange-500">
                            ...
                            <div className='flex items-center mt-5 gap-x-3 gap-y-2'>
                                {auth.user ? (
                                    <a href={`/connect/${auth.user.id}/${announcement.id}`}
                                       className='text-white text-center shadow-lg shadow-orange-500/50 rounded-lg text-center items-center w-full block bg-orange-500 py-2 px-5 md:px-10'>
                                ...
                                <div
                                    ...
                                    className={`border-2 ${isFavorite ? 'border-transparent' : 'border-orange-500'} rounded-lg inline-block px-3 py-2 cursor-pointer transition-all duration-150`}>
                                    {isFavorite ? (
                    ...
                    <div className="md:col-span-2">
                        <div className=''>
                            ...
                            <div className='text-2xl md:text-3xl mt-1 font-bold text-orange-500 max-w-[700px]'>{announcement.title}</div>
                        ...
                        <Link href='/announcements' className="mt-5 border-b-2 py-2 border-orange-500 inline-block font-bold">Больше объявлений</Link>
                        {urgent_announcement && (
