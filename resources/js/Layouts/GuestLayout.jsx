        ...
        <div className="fixed bottom-0 left-0 w-full">
          <div className="bg-white grid grid-cols-4 w-full py-3 px-3">
            <Link
              ...
              href="/"
            >
                <svg className="text-center text-2xl mx-auto" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <Link
              ...
              href="/announcements"
            >
                <svg className="mx-auto text-2xl" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            >
              <div>
                  <svg className="text-2xl mx-auto" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                          fill-rule="evenodd"
                          clip-rule="evenodd"
            ...
            <div></div>
              <div className="md:absolute md:bottom-5 text-md text-gray-500">
                  <a href="https://t.me/jumystapjobs/" target="_blank" rel="noopener noreferrer" className="flex justify-start">
                      <FaTelegram className="text-xl" /> <span className="ml-1">Получайте вакансии в Telegram!</span>
                  </a>
